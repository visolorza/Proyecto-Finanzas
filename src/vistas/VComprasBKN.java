 ...
 */
public class VComprasBKN extends javax.swing.JFrame {
    ...
    public VComprasBKN() {
        ...
        try {
            ...
            Logger.getLogger(VComprasBKN.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jcbo_gastosMesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcbo_gastosMesActionPerformed
        ...
        switch (opcion) {
            case "Compras":
                VComprasBKN compras = new VComprasBKN();
